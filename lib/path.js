...
// vendored from node.js v6 @ dfaa9c905530e30bd02d713c37546febb7446257
  ...
  resolve: function resolve() {
    ...
    for (var i = arguments.length - 1; i >= -1; i--) {
      ...
      if (i >= 0) {
        ...
        path = cppBridge.env['=' + resolvedDevice];
    ...
    // but handle relative paths to be safe (might happen when cppBridge.cwd()
    // fails)
